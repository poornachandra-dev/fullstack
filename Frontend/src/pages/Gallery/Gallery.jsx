...
import { ArrowDownToLine, CircleChevronLeft, Heart, Play, SlidersHorizontal } from "lucide-react";
    ...
    <section className="gallery">
      ...
      {searchQuery && isSearchPerformed ? (
        <div className="search_head">
          <CircleChevronLeft size={46} strokeWidth={1.5} onClick={() => setSearchQuery('')} className="search_back"/>
...

                    {
                      media.displayType === 'ai-image' ? (
                        ...
                        <>
                          ...
                          {media.displayType !== 'ai-image' && (
                            <>
                              <span className="img_like" title="Like Image" onClick={() => handleLike(media._id, media.isLiked)}>
                              <Heart
                                size={20}
                                strokeWidth={1.75}
                                color={media.isLiked ? "#FF0000" : "black"}
                                fill={media.isLiked ? "#FF0000" : "none"}
